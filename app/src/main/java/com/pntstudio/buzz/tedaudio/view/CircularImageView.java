package com.pntstudio.buzz.tedaudio.view;
...
public class CircularImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, true)) {
            ...
            setBorderColor(attributes.getColor(R.styleable.CircularImageView_civ_border_color, WHITE));
        }

        setBackgroundColor(attributes.getColor(R.styleable.CircularImageView_civ_background_color, WHITE));
